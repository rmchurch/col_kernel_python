...
class sml_param(object):
    def __init__(self):
        ...
        #! Input variables
        self.sml_dt = (
            0.25e0  #!< Collision time step in units of the electron collision time
        )
        ...
        self.sml_den = [
            ...
            3.33e16,
            1.667e16,
        ]  #!< Density of each species make sure that the sum of
        ...
        self.sml_mass = [
            ...
            7e0,
            12e0,
        ]  #!< Mass of each species in units of the proton mass
        self.sml_charge = [
            -1e0,
            1e0,
            3e0,
            6e0,
        ]  #!< Charge of each species, in units of the elementary charge
        # self.__dict__ = self
        #! Time and time step
...
class f0_param(dict):
    def __init__(self):
        self.f0_nnode = (
            1  #!< Total number of (independent) collision operations per time step
        )
        self.f0_node_mult = (
            1  #!< Multiplier for number of grid points ("m" in comment on f0_nnode)
        )
        ...
        self.f0_smu_max = (
            4.0  #!< Perp. velocity cutoff in units of the thermal velocity
        )
        self.f0_vp_max = (
            4.0  #!< Parallel velocity cutoff in units of the thermal velocity
        )
